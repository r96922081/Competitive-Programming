...
bool used[1000001];
bool modulus2[1000001];
bool modulus3[1000001];

bool TestSegConflict(int start1, int end1, int start2, int end2)
{
...
bool TestConflict(vector<pair<int, int>>& one_time_jobs, vector<tuple<int, int, int>>& repeated_jobs)
{
