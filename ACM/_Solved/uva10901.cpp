...
void UpdateWaitingCars(queue<InputCar>& input_cars, int current_time, queue<Car>& waiting_cars_in_left_bank, queue<Car>& waiting_cars_in_right_bank)
{
...
void LoadCars(string ferry_side, vector<Car>& cars_in_ferry, int ferry_capacity, queue<Car>& waiting_cars_in_left_bank, queue<Car>& waiting_cars_in_right_bank)
{
	if (ferry_side == "left")
	{
...
void Unload(vector<Car>& cars_in_ferry, int current_time, vector<Car>& result)
{
...
void CrossRiver(string& ferry_side, int& current_time, int time_to_cross_river)
{
	if (ferry_side == "left")
		ferry_side = "right";
	else
