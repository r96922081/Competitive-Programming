...
bool C5CheckRowCol(int row, int col)
{
...
void PrintC1(string command, string font, int row, string str, string arg3)
{
	if (command == ".P")
	{
...
void PrintC5LeftToRight(int row, int col, string str)
{
...
void PrintC5RightToLeft(int row, int col, string str)
{
	for (int i = 0; i < str.size(); i++, col -= 6)
	{
...
void PrintC5(string command, string font, int row, string str, string arg3)
{
