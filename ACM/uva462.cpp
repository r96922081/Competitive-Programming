...
int rule_1_to_4(bool* all_cards, int* card_count_in_suit)
{
	int ret = 0;
...
int rule_5_to_7(bool* all_cards, int* card_count_in_suit)
{
	int ret = 0;
...
bool suit_all_stop(bool* all_cards, int* card_count_in_suit)
{
	for (int i = 0; i < 4; i++)
	{
		int base = i * 13;
